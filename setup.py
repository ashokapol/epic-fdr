...
opts = {
    'py2exe': { "includes" : ["sip", "matplotlib.numerix.ma", "matplotlib.backends",  "matplotlib.backends.backend_qt4agg",
...
setup(windows=[{"script" : "epic.py"}], options=opts,   data_files=data_files)
