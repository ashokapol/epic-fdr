...
from epicUIelements.ui_dlgSpectrumMillPara import Ui_mdlgSpectrumMillPara
import qrc_epicResources


class clsSelectSpectrumMillVars(QtGui.QDialog):
    def __init__(self):
        QtGui.QDialog.__init__(self)
        self.ui = Ui_mdlgSpectrumMillPara()
    ...
    def GetVars(self):
        boolListCS = [self.ui.mchkBoxCS1.isChecked(), self.ui.mchkBoxCS2.isChecked(), \
                                   self.ui.mchkBoxCS3.isChecked(), self.ui.mchkBoxCSother.isChecked()]
